...
func TestPrepareEnrichment(t *testing.T) {
	...
	testCases := []struct {
		...
		// invalid flag format
		{
			...
			expectedReturn: EnrichmentConfig{},
			expectedError:  "flags.PrepareEnrichment: invalid enrichment flag: container.enabledtrue, use 'tracee man enrichment' for more info",
		},
		{
			testName:       "invalid flag format empty value",
			flags:          []string{"container.enabled="},
			expectedReturn: EnrichmentConfig{},
			expectedError:  "flags.PrepareEnrichment: invalid enrichment flag: container.enabled=, use 'tracee man enrichment' for more info",
		},
		{
			testName:       "invalid boolean flag with =true",
			flags:          []string{"container.enabled=true"},
			expectedReturn: EnrichmentConfig{},
			expectedError:  "flags.PrepareEnrichment: invalid enrichment flag: container.enabled=true, use 'tracee man enrichment' for more info",
		},
		{
			testName:       "invalid boolean flag resolve-fd with =true",
			flags:          []string{"resolve-fd=true"},
			expectedReturn: EnrichmentConfig{},
			expectedError:  "flags.PrepareEnrichment: invalid enrichment flag: resolve-fd=true, use 'tracee man enrichment' for more info",
		},
		{
			testName:       "invalid boolean flag exec-hash.enabled with =true",
			flags:          []string{"exec-hash.enabled=true"},
			expectedReturn: EnrichmentConfig{},
			expectedError:  "flags.PrepareEnrichment: invalid enrichment flag: exec-hash.enabled=true, use 'tracee man enrichment' for more info",
		},
		{
			testName:       "invalid boolean flag user-stack-trace with =true",
			flags:          []string{"user-stack-trace=true"},
			expectedReturn: EnrichmentConfig{},
			expectedError:  "flags.PrepareEnrichment: invalid enrichment flag: user-stack-trace=true, use 'tracee man enrichment' for more info",
		},
		{
			testName:       "invalid boolean flag container.cgroup.force with =true",
			flags:          []string{"container.cgroup.force=true"},
			expectedReturn: EnrichmentConfig{},
			expectedError:  "flags.PrepareEnrichment: invalid enrichment flag: container.cgroup.force=true, use 'tracee man enrichment' for more info",
		},
		// invalid flag name
		{
			...
			expectedReturn: EnrichmentConfig{},
			expectedError:  "flags.PrepareEnrichment: invalid enrichment flag: invalid-flag, use 'tracee man enrichment' for more info",
		},
		{
			testName:       "invalid flag name with typo",
			flags:          []string{"container.enable=true"},
			expectedReturn: EnrichmentConfig{},
			expectedError:  "flags.PrepareEnrichment: invalid enrichment flag: container.enable, use 'tracee man enrichment' for more info",
		},
		{
			testName:       "invalid flag name empty",
			flags:          []string{"=true"},
			expectedReturn: EnrichmentConfig{},
			expectedError:  "flags.PrepareEnrichment: invalid enrichment flag: , use 'tracee man enrichment' for more info",
		},
		// valid edge cases
		{
		...
		},
		{
			...
			expectedReturn: EnrichmentConfig{},
			expectedError:  "flags.PrepareEnrichment: invalid enrichment flag: resolve, use 'tracee man enrichment' for more info",
		},
	}
