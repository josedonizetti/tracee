...
func GetStringFromEventValue(eventValue *pb.EventValue) string {
	switch v := eventValue.Value.(type) {
	...
	case *pb.EventValue_StrArray:
		return fmt.Sprintf("%v", v.StrArray.Value)
	...
	case *pb.EventValue_Sockaddr:
		return fmt.Sprintf("%v", v.Sockaddr)
	case *pb.EventValue_Credentials:
		return fmt.Sprintf("%v", v.Credentials)
	case *pb.EventValue_Timespec:
		return fmt.Sprintf("%v", v.Timespec)
	case *pb.EventValue_TriggeredBy:
		return fmt.Sprintf("%v", v.TriggeredBy)
	case *pb.EventValue_HookedSyscalls:
		return fmt.Sprintf("%v", v.HookedSyscalls)
	case *pb.EventValue_HookedSeqOps:
		return fmt.Sprintf("%v", v.HookedSeqOps)
	case *pb.EventValue_Ipv4:
		return fmt.Sprintf("%v", v.Ipv4)
	case *pb.EventValue_Ipv6:
		return fmt.Sprintf("%v", v.Ipv6)
	case *pb.EventValue_Tcp:
		return fmt.Sprintf("%v", v.Tcp)
	case *pb.EventValue_Udp:
		return fmt.Sprintf("%v", v.Udp)
	case *pb.EventValue_Icmp:
		return fmt.Sprintf("%v", v.Icmp)
	case *pb.EventValue_Icmpv6:
		return fmt.Sprintf("%v", v.Icmpv6)
	case *pb.EventValue_Dns:
		return fmt.Sprintf("%v", v.Dns)
	case *pb.EventValue_DnsQuestions:
		return fmt.Sprintf("%v", v.DnsQuestions)
	case *pb.EventValue_DnsResponses:
		return fmt.Sprintf("%v", v.DnsResponses)
	case *pb.EventValue_PacketMetadata:
		return fmt.Sprintf("%v", v.PacketMetadata)
	case *pb.EventValue_Http:
		return fmt.Sprintf("%v", v.Http)
	case *pb.EventValue_HttpRequest:
		return fmt.Sprintf("%v", v.HttpRequest)
	case *pb.EventValue_HttpResponse:
		return fmt.Sprintf("%v", v.HttpResponse)
