...
func NewDefaultProbeGroup(module *bpf.Module, netEnabled bool, kSyms *helpers.KernelSymbolTable) (*ProbeGroup, error) {
	...
	allProbes := map[Handle]Probe{
		...
		LegacyCgroupSKBIngress:      NewCgroupProbe(bpf.BPFAttachTypeCgroupInetIngress, "legacy_cgroup_skb_ingress"),
		LegacyCgroupSKBEgress:       NewCgroupProbe(bpf.BPFAttachTypeCgroupInetEgress, "legacy_cgroup_skb_egress"),
		...
		FentrySecuritySocketSendmsg: NewTraceProbe(Fentry, "fentry_security_socket_recvmsg", "fentry_security_socket_recvmsg"),
		FentrySecuritySocketRecvmsg: NewTraceProbe(Fentry, "fentry_security_socket_sendmsg", "fentry_security_socket_sendmsg"),
	}
