...
tracee **\-\-output** destinations.*name*.*field*=*value* | option:sort-events
...
- **option:sort-events**: Enable sorting events before passing them to output. May decrease overall program efficiency.
